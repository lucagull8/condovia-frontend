...
export function LogoMark({ size = 28 }) {
  return (
    <svg width={size} height={size} viewBox="0 -3.5 147 147" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Ring: gap from ~1 o'clock to ~2 o'clock, coordinates exact from brand SVG source */}
      <path d="M 90,25 A 42.5,42.5 0 1 0 108,38"
            stroke="currentColor" strokeWidth="9" strokeLinecap="round"/>
      {/* Tall white building */}
      <rect x="62.5" y="37" width="23" height="91" fill="white" stroke="currentColor" strokeWidth="2"/>
      {/* Copper trapezoid */}
      <polygon points="91.1,66.3 111.9,79.8 113,121.3 91.1,127" fill="#B06D30"/>
    </svg>
  );
}
